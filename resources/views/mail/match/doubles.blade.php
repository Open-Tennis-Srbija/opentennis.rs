...
<br>
<a href="{{ url('/' . $winner1_uri) }}">Pogledaj {{$winner1}}</a>
<br>
<a href="{{ url('/' . $winner2_uri) }}">Pogledaj {{$winner2}}</a>
<br>
<a href="{{ url('/' . $loser1_uri) }}">Pogledaj {{$loser1}}</a>
<br>
<a href="{{ url('/' . $loser2_uri) }}">Pogledaj {{$loser2}}</a>
<br>
