...
<template>
    <Head title="Import dublova -" />
    <div class="static-wrapper">
    <h1 id="title" :class="{'hide': formState.success}">Import dublova</h1>
    ...
    <form id="form" @submit.prevent="submit" :class="{'hide': formState.success}">
      ...
      <div class="form-section">
        ...
        <div class="form-row">
          ...
          <div class="form-group">
            <p>Potrebno je exportovati <a href="/storage/SrpskaTenisLiga.rs prijava turnira i liga - dublovi - šablon.xlsx" target="_blank">spreadsheet</a> (Google sheet ili Excel) kao .csv fajl.</p>
