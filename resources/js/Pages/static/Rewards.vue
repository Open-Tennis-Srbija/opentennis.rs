...
<template>
    ...
    <Head title="Nagrade partnera 2025 -" />
    <div class="static-wrapper">
        <h1 class="mobile-neg-margin text-align-center">NAGRADE PARTNERA 2025</h1>
...
.promo-wrapper{
    ...
    .promo{
        ...
        .img-wrapper{
            ...
            &.crazy-pizza{
                background: $crazy-pizza-red;
            }
            &.plavinci{
                background: $plavinci-blue;
            }
            &.abramo{
                background: $abramo-black;
            }
            .promo-image{
                display: block;
                max-width: 180px;
